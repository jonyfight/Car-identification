    ...
    try:
        ...
        if img is not None:
            ...
            return img_rgb
             ...
             print (" utf8 " + str(img_path.encode(encoding='UTF-8')))
             print (" GB18030 " + str(img_path.encode(encoding='GB18030')))
             print (" img_path=" + img_path+'\n')
             return None
    except:
        print("read image error: {} {}".format(sys.exc_info(), img_path))
...
class SequenceData(Sequence):
    def __init__(self, data_list, nbr_classes=3, batch_size=32, return_label=True,
